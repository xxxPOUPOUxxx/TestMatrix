...
#[derive(Debug)]
pub struct TestMatrixProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TestMatrixProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TestMatrix processing");
    
    let mut processor = TestMatrixProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TestMatrixProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TestMatrixProcessor::new(false);
